...
namespace App74.ViewModels
{
...

    {
        ...
        private ObservableCollection<Models.ChangeCourseTime> _student = new ObservableCollection<Models.ChangeCourseTime>();



        public ObservableCollection<Models.ChangeCourseTime> Students
        {
            get
            {
