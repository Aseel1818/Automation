...
namespace App74.Views
{
    ...
    public partial class RegisterCourse : ContentPage
    {
        public RegisterCourse()
        {
            InitializeComponent();
            BindingContext = new RegisterCourseModelView();
        ...
        async void Submit_Clicked(object sender, EventArgs e)
        {
            ...
            App.Current.MainPage.DisplayAlert("Alert", "Register form saved successfuly ", "OK");
